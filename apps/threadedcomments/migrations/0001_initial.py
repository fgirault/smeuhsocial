    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('markup', models.IntegerField(default=5, null=True, blank=True, choices=[(1, 'Markdown'), (5, 'Plain text')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_approved', models.DateTimeField(default=None, null=True, verbose_name='date/time approved', blank=True)),
                ('comment', models.TextField(verbose_name='Comment')),
                ('markup', models.IntegerField(default=5, blank=True, choices=[(1, 'Markdown'), (5, 'Plain text')])),
                ('is_public', models.BooleanField(default=True, verbose_name='is public')),
                ('is_approved', models.BooleanField(default=False, verbose_name='is approved')),
